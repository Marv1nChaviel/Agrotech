    ...
    var t = {
            ...
            5975: (t, e, i) => {
                ...
                function jt(t, e) {
                    var i = Pt(t),
                        n = Pt(e);
                    if (2 !== i.length) throw new Error(" line1 must only contain 2 coordinates");
                    if (2 !== n.length) throw new Error(" line2 must only contain 2 coordinates");
                    var r = i[0][0],
                        a = i[0][1],
                        o = i[1][0],
                        s = i[1][1],
                ...
                const Ut = function(t, e) {
                    ...
                    var i = e.precision,
                        n = e.coordinates,
                        r = e.mutate;
                    if (i = i === undefined || null === i || isNaN(i) ? 6 : i, n = n === undefined || null === n || isNaN(n) ? 3 : n, !t) throw new Error(" is required");
                    if ("number" != typeof i) throw new Error(" must be a number");
